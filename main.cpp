...
char baku[][20] = {
    ...
    "blanko", "boks", "bosan", "bus", "cabai", "capai", "cedera", "cendekiawan", "cengkih",
    "cinderamata", "cokelat", "daftar", "derajat", "detail", "detergen", "diagnosis",
    ...
    "omzet", "otomatis", "paham", "pasif", "paspor", "pembaruan", "penasihat", "perajin",
    ...
    "rontgen", "rubuh", "sahaja", "saksama", "samudra", "sangsi", "saraf", "satai", "sekadar",
...
char notBaku[][20] = {
    ...
    "blangko", "bok", "bosen", "bis", "cabe", "capek", "cidera", "cendikiawan", "cengkeh",
    "cenderamata", "coklat", "daptar", "derajad", "detil", "deterjen", "diagnosa",
    ...
    "omset", "automatis", "faham", "pasive", "pasport", "pembaharuan", "penasehat", "pengrajin",
    ...
    "ronsen", "roboh", "sehaja", "seksama", "samudera", "sanksi", "syaraf", "sate", "sekedar",
